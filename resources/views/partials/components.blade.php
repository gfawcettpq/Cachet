...
<ul class="list-group components">
    ...
    <li class="list-group-item group-name">
        ...
        <div class="pull-right">
            <i class="uxf-icon uxf-record text-component-{{ $componentGroup->lowest_status }} {{ $componentGroup->lowest_status_color }}" data-toggle="tooltip" title="{{ $componentGroup->lowest_human_status }}"></i>
        </div>
    </li>
